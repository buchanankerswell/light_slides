...
echo $fg_bold[green] "downloading videos in best .mp4 format"
...
# Download playlist
youtube-dl --dateafter $lastdl -f 'bestvideo[ext=mp4]/bestvideo' -i PL8dDgAwuMuPTXCj0MPO_G6jTz4pzXVcZi -o '%(title)s.%(ext)s' --restrict-filenames
